      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            <Link to="/cart" className="relative p-2" aria-label="View your cart">
              <svg 
                xmlns="http://www.w3.org/2000/svg" 
                className={`h-6 w-6 ${darkMode ? 'text-light' : 'text-gray-800'} hover:text-primary transition-colors duration-300`} 
                fill="none" 
                viewBox="0 0 24 24" 
                stroke="currentColor"
              >
